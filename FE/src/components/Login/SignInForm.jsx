            ...
            <div className="panels-container">
                <div className="panel left-panel">
                    <div className="content">
                        ...
                        <p>Create an account to easily book appointments, access your medical records, and manage your health with just a few clicks. Sign up now to get started on your healthcare journey!</p>
                ...
                <div className="panel right-panel">
                    <div className="content">
                        ...
                        <p>Welcome back! Log in to access your account and continue booking doctor with us.!</p>
